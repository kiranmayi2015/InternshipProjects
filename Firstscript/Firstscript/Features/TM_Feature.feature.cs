...
namespace Firstscript.Features
{
...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "Features", "TM_Feature", "As a Turnup Portal admin\r\nI would like to Create, Edit and Delete Time and Materi" +
                    "als records\r\nso that i can manage employees Time and materials details successfu" +
...
#line hidden
        ...
        [NUnit.Framework.TestCaseAttribute("Time", "Kiran", "$15", null)]
        [NUnit.Framework.TestCaseAttribute("Material", "Keyboard", "$500", null)]
        [NUnit.Framework.TestCaseAttribute("Editedrecord", "Mouse", "$100", null)]
...
#line hidden
#line 17
 testRunner.Then(string.Format("The record should have updated \'{0}\', \'{1}\' and \'{2}\'", description, code, price), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
            }
            this.ScenarioCleanup();
        }
